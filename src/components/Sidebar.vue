<template>
  <div class="z-10">
    <div class="h-[110rem] bg-white shadow-lg shadow-gray-300 w-60 px-10 py-5">
      <router-link to="/homepage">
        <li
          class="flex p-5 rounded-lg items-center font-light justify-start cursor-pointer hover:fill-sky-700 hover:text-sky-700 transition-all duration-300 ease-in-out"
        >
          <svg
      ...
      <router-link
        to="/create"
        class="flex p-5 rounded-lg items-center font-light justify-start cursor-pointer hover:fill-sky-700 active:text-sky-700 active:fill-sky-700 hover:text-sky-700 transition-all duration-300 ease-in-out"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
